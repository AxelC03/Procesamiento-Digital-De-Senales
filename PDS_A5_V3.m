...
if Y == 1
    ...
    nums4=conv(nums2,nums2);
    dens4=conv(dens2,dens2);
    nums5=conv(nums3,nums2);
    dens5=conv(dens3,dens2);
    nums6=conv(nums3,nums3);
    dens6=conv(dens3,dens3);
    nums7=conv(nums4,nums3);
    dens7=conv(dens4,dens3);
    nums8=conv(nums4,nums4);
    dens8=conv(dens4,dens4);
    nums9=conv(nums5,nums4);
    dens9=conv(dens5,dens4);
    nums10=conv(nums5,nums5);
    dens10=conv(dens5,dens5);
    ...
    disp('NO se puede filtrar el audio :(')
    disp('  ')
end
